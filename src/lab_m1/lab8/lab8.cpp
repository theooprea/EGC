...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    lightRotation = glm::rotate(lightRotation, spotlightOY, glm::vec3(0, 1, 0));
    lightRotation = glm::rotate(lightRotation, spotlightOX, glm::vec3(1, 0, 0));

    lightDirection = glm::vec3(lightRotation * glm::vec4(0, -1, 0, 0));

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 1, 0));
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.8, 0, 0));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0, 0.8, 0));
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.3, 0.3, 0.8));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int type = glGetUniformLocation(shader->program, "light_type");
    glUniform1i(type, lightType);
